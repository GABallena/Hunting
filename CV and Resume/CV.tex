...
\cvitem{Intermediate}{Visualizing GeoSpatial Data in \texttt{Python} \dotfill 2024}
\cvitem{Intermediate}{Working with Geospatial Data in \texttt{Python} \dotfill 2024}
\cvitem {Intermediate}{Unsupervised learning in \texttt{Python} \dotfill 2024}
\cvitem {Advanced}{Ensemble Methods in \texttt{Python} (Bagging, Boosting, Stacking) \dotfill 2024}
