...
% Set fonts to Garamond and Courier
\setmainfont{EB Garamond}
\setsansfont{EB Garamond} % Or another sans-serif font if Garamond causes issues
...
\subsection{Relavant Courses}
\begin{multicols}{2}
	\begin{itemize}
		\item Industrial microbiology
		\item Molecular Phylogenetics
		\item Epigenetics
		\item Advanced Cell and Molecular Biology
	\end{itemize}
\end{multicols}
...
\cvitem {Intermediate}{Supervised Learning with sci-kit learn \dotfill 2024}
\cvitem{Intermediate}{Visualizing GeoSpatial Data in \texttt{Python} \dotfill 2020}
\cvitem{Introductory}{COVID-19: What You Need to Know \dotfill 2020}4\cvitem{Introductory}{Essential Epidemiologic Tools for Public Health Practice \dotfill 2020}
\cvitem{Introductory}{Essential Epidemiologic Tools for Public Health Practice \dotfill 2020}
\cvitem {Intermediate}{Unsupervised learning in Python \dotfill 2024}
\cvitem {Advanced}{Ensemble Methods in Python (Bagging, Boosting, Stacking) \dotfill 2024}
...
\begin{multicols}{2}
	...
	\end{itemize}
\end{multicols}
\cvitem{Intermediate}{Visualizing Geospatial Data in R \dotfill 2024}
